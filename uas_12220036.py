...
with n_besar_negara:
    ...
    try:
        ...
        minyakTahun.index = minyakTahun.index + 1
        st.write(minyakTahun)
    except Exception:
        st.error('Pastikkan anda memasukkan angka pada kolom yang tersedia')
...
with n_terbesar:
    ...
    try:
        ...
        sumProduksi = sumProduksi[:int(userJmlInputRank)]
        sumProduksi.index = sumProduksi.index + 1
        st.write(sumProduksi)
    except Exception:
        st.error('Pastikkan anda memasukkan angka pada kolom yang tersedia')
